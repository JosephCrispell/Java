...
public class methods {
	...
	public static void main(String[] args) throws IOException {
		...
		Tree tree = new Tree(path + "example-AFTER_02-08-18.tree");

		// Read in the sequences
		Sequence[] sequences = GeneticMethods.readFastaFile(path + "example_02-08-18.fasta", false);
		...
		consistency.printSequencesWithoutInConsistentSites(path + "example_withoutInconsistentSites_02-08-18.fasta");
		
		// Create an annotated NEWICK tree file
		consistency.printAnnotatedTree(path + "example-AFTER_withInconsistentSitesAnnotated_02-08-18.tree");
		
		// Create a report file
		consistency.printSummary(path + "consistencyIndexReport_02-08-18.tree");
