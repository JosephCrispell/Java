...
public class SnpInfo {
	...
	public SnpInfo(String snpInfoLine, String file){
		...
		this.alt = getAlternateAllele(cols[4], this.formatCol, this.pos,
	...
	public static char getAlternateAllele(String col, Hashtable<String, double[]> format, int snpPos, 
			Hashtable<String, double[]> info, double quality, char refAllele){
